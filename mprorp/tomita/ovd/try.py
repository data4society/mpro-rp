...
#f1('locations')
#record = session.query(Record).filter(Record.document_id == 'b185d383dbc282203fe5590c7b1e4da0').first()
doc = session.query(Document).filter(Document.doc_id == '2d7d190c-90fc-4391-b41c-afbca49126e1').first()
