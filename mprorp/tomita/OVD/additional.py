...
def get_types(name):
    types = {'_министерство внутренний дело_мвд_' : ['министерство внутренних дел', 'мвд'],
            ...
            '_межмуниципальный управление_' : ['межмуниципальное управление'],
             ...
             '_отдел полиция_отделение полиция_оп_омвд_отдел мвд_отдел министерство внутренний дело_' :
                 ['отдел полиции', 'отделение полиции', 'оп ', 'омвд', 'отдел мвд', 'отдел министерства внутренних дел'],
