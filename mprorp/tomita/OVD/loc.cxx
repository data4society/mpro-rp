...
Other2 -> Other0+ | Adj<h-reg1> | Noun<h-reg1, wfl=~'(ОВД|в|В)'> | UnknownPOS<h-reg1>;
...
Loc -> Loc2<~l-quoted, ~r-quoted> | Loc3<~l-quoted, ~r-quoted> | Loc4<~l-quoted, ~r-quoted> | Loc5<~l-quoted, ~r-quoted>;
Loc_Geo -> Loc1<~l-quoted, ~r-quoted>;

Allw -> All {weight = 0.9};
City -> Loc6 {weight = 0.5};
Locw -> Loc {weight = 0.6};
Geow -> Loc_Geo {weight = 0.3};

Location -> Locw interp(LocationFact_TOMITA.Location_TOMITA::not_norm) | Allw | City interp(LocationFact_TOMITA.City_TOMITA::not_norm) | Geow interp(LocationFact_TOMITA.Location_TOMITA::not_norm);