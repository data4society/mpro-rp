            ...
            for variant in ovd:
                if len(variant[0]['codes']) == n:
                    try:
                        ...
                        if 'no_loc_used_norm' not in out2:
                            out2['no_loc_used_norm'] = [[variant], [variant[0]['codes'][0]]]
                        else:
                            out2['no_loc_used_norm'][0].append(variant)
                            out2['no_loc_used_norm'][0].append(variant[0]['codes'][0])
        out.append(out2)
    out3 = []
    for ovd in out:
        out2 = []
