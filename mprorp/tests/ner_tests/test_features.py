...
class SimpleTomitaTest(unittest.TestCase):
    ...
    def test_tomita_person(self):
        ...
        my_doc = Document(stripped=my_text, type='article')
        insert(my_doc)
...
my_text = '''(ЗАО СЭК), и Эвелине Оськиной. Факты смены собственников у всех объектов недвижимости подтверждались базами данных, в частности, Росреестра и ЕГРЮЛ.
Между тем в ноябре 2015 года на заседании совета по культуре при председателе Госдумы Сергее Нарышкине продюсер и композитор Игорь Матвиенко заявил, что работа РАО "полностью заблокирована" и счета организации заморожены в связи с проверками "по фактам хищений" на сумму около миллиарда рублей. Всех членов авторского совета, рассказал он, вызывали в правоохранительные органы для дачи показаний, а дело передается в прокуратуру. Позже в организации опровергли его слова о существовании уголовного дела и о блокировке счетов.
П'''